...
@Component({
  ...
  imports: [ReactiveFormsModule, CommonModule, HttpClientModule, 
    ...
    MatPaginatorModule,
    MatSortModule,MatToolbarModule, MatFormFieldModule,
    MatInputModule,
    MatSelectModule],
...
export class CandidatosOfertadosComponent {
  ...
  constructor(private fb: FormBuilder, private ofertaService: OfertasService, private ubicacionService: UbicacionService,private dialog: MatDialog) {
  }

  ofertaLista:Ofertas[]
  provinciaLista:Ubicacion[]

  candidatoForm = this.fb.group({
  ...
  // Método para abrir el popup directamente en el componente
